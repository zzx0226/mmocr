...
class BSNetTargets_Out5(TextSnakeTargets):
    ...
    def __init__(self,
                 ...
                 level_size_divisors=(4, 8, 16, 32, 60),
                 #  level_proportion_range=((0, 0.4), (0.3, 0.7), (0.6, 1.0))
                 level_proportion_range=(
                     (0, 0.3), (0.2, 0.5), (0.4, 0.7), (0.6, 0.9), (0.8, 1.0))
                 ):
    ...
    def generate_targets(self, results):
        ...
        mapping = {
            'p2_maps': level_maps[0], 'p3_maps': level_maps[1], 'p4_maps': level_maps[2], 'p5_maps': level_maps[3], 'p6_maps': level_maps[4]}
