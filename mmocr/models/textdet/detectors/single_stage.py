...
class SingleStageDetectorTood(BaseDetector):
    ...
    def __init__(self, backbone, neck=None, bbox_head=None, train_cfg=None, test_cfg=None, pretrained=None, init_cfg=None):
        super(SingleStageDetectorTood, self).__init__(init_cfg)
        if pretrained:
    ...
    def forward_train(self, img, img_metas, gt_bboxes, gt_labels, gt_cp, gt_bboxes_ignore=None):
        """
        Args:
        ...
        """
        super(SingleStageDetectorTood, self).forward_train(img, img_metas)
        x = self.extract_feat(img)
        losses = self.bbox_head.forward_train(x, img_metas, gt_bboxes, gt_cp, gt_labels, gt_bboxes_ignore)
        return losses
