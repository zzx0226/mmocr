...
class WLNet_FCOS(BaseDetector):
    ...
    def __init__(self, backbone, neck=None, bbox_head=None, train_cfg=None, test_cfg=None, pretrained=None, init_cfg=None):
        ...
        super(WLNet_FCOS, self).__init__(init_cfg)
        if pretrained:
    ...
    def forward_train(self, img, img_metas, gt_bboxes, gt_labels, gt_wl, gt_bboxes_ignore=None):

        super(WLNet_FCOS, self).forward_train(img, img_metas)
        x = self.extract_feat(img)
        losses = self.bbox_head.forward_train(x, img_metas, gt_bboxes, gt_wl, gt_labels, gt_bboxes_ignore)
        return losses
