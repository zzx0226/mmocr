...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/bsnet_test_bbox/latest.pth'
workflow = [('train', 1)]
...
model = dict(
    ...
    bbox_head=dict(
        ...
        in_channels=256,
        scales=(8, 16, 32),
        loss=dict(type='BSLoss_bbox', bs_degree=4, cp_num=5),
        postprocessor=dict(
            type='BSPostprocessor_bbox',
            bs_degree=4,
            cp_num=5,
...
work_dir = './work_dirs/bsnet_test_bbox'
gpu_ids = range(0, 1)
