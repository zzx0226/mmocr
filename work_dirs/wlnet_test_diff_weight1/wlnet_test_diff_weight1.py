...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/wlnet_test_diff_weight1/latest.pth'
workflow = [('train', 1)]
...
model = dict(
    ...
    neck=dict(
        ...
        act_cfg=None),
    bbox_head=dict(
        type='WLHead_diff_weight',
        in_channels=256,
        scales=(8, 16, 32),
        loss=dict(type='WLLoss_diff_weight', wavelet_type='sym5'),
        postprocessor=dict(
            type='WLPostprocessor_diff_weight',
...
work_dir = './work_dirs/wlnet_test_diff_weight1'
gpu_ids = range(0, 1)
