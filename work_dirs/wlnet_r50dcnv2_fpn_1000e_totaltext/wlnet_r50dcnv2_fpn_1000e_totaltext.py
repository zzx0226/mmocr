...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/wlnet_r50dcnv2_fpn_1000e_totaltext/epoch_970.pth'
workflow = [('train', 1)]
optimizer = dict(type='Adam', lr=0.0001)
optimizer_config = dict(grad_clip=None)
lr_config = dict(policy='step', step=[700, 1400])
total_epochs = 1500
wavelet_type = 'dmey'
reconstr_points = 50
model = dict(
...
data_root = '/home/atom/Research_STD/Datasets/mmocr/totaltext'
train = dict(
    type='IcdarDataset',
    ann_file=
    '/home/atom/Research_STD/Datasets/mmocr/totaltext/instances_training.json',
    img_prefix='/home/atom/Research_STD/Datasets/mmocr/totaltext/imgs',
    pipeline=None)
test = dict(
    type='IcdarDataset',
    ann_file=
    '/home/atom/Research_STD/Datasets/mmocr/totaltext/instances_test.json',
    img_prefix='/home/atom/Research_STD/Datasets/mmocr/totaltext/imgs',
    pipeline=None)
train_list = [
    dict(
    ...
    train=dict(
        ...
        datasets=[
            dict(
                ...
                '/home/atom/Research_STD/Datasets/mmocr/totaltext/instances_training.json',
                img_prefix=
                '/home/atom/Research_STD/Datasets/mmocr/totaltext/imgs',
                pipeline=None)
        ],
        pipeline=[
            dict(
...
work_dir = './work_dirs/wlnet_r50dcnv2_fpn_1000e_totaltext'
gpu_ids = range(0, 1)
