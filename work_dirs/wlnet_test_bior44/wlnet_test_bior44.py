...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/wlnet_test_bior44/latest.pth'
workflow = [('train', 1)]
...
model = dict(
    ...
    bbox_head=dict(
        ...
        in_channels=256,
        scales=(8, 16, 32),
        loss=dict(type='WLLoss_test', wavelet_type='bior4.4'),
        postprocessor=dict(
...
work_dir = './work_dirs/wlnet_test_bior44'
gpu_ids = range(0, 1)
