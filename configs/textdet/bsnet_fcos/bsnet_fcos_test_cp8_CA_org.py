...
model = dict(type='BSNet_fcos',
             ...
             bbox_head=dict(type='BS_FCOSHead',
                            bs_degree=4,
                            cp_num=8,
                            num_classes=1,
                            in_channels=256,
...
train = dict(type='IcdarDataset',
             ann_file='/home/atom/Research_STD/Datasets/mmocr/ctw1500/instances_training.json',
             img_prefix='/home/atom/Research_STD/Datasets/mmocr/ctw1500/imgs',
             pipeline=None)
test = dict(type='IcdarDataset',
            ann_file='/home/atom/Research_STD/Datasets/mmocr/ctw1500/instances_test.json',
            img_prefix='/home/atom/Research_STD/Datasets/mmocr/ctw1500/imgs',
            pipeline=None)
train_list = [
    dict(type='IcdarDataset',
         ann_file='/home/atom/Research_STD/Datasets/mmocr/ctw1500/instances_training.json',
         img_prefix='/home/atom/Research_STD/Datasets/mmocr/ctw1500/imgs',
         pipeline=None)
]
...
train_pipeline_icdar2015 = [
    ...
    dict(type='ColorJitter', brightness=0.12549019607843137, saturation=0.5, contrast=0.5),
    ...
    dict(type='CustomFormatBundle', keys=['gt_bboxes', 'gt_cp'], visualize=dict(flag=False, boundary_key=None)),
