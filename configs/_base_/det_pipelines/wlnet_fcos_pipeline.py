...
train_pipeline_icdar2015 = [
    ...
    dict(type='WLNetFcosTargets', wavelet_type='haar'),
    dict(type='CustomFormatBundle', keys=[
         'gt_bboxes', 'gt_wl', 'gt_lables'], visualize=dict(flag=False, boundary_key=None)),
    # dict(type='FormatBundle_wl'),
    dict(type='Collect', keys=['img', 'gt_bboxes', 'gt_wl', 'gt_labels'])
]
