...
Version: 1.0
Autor: Zhangzixu
Date: 2022-01-03 10:08:04
LastEditors: Zhangzixu
LastEditTime: 2022-01-03 10:25:53
'''
...
train_pipeline_icdar2015 = [
    ...
    dict(type='BSNetTargets', bs_degree=4, cp_num=14, resample_num=100,
...
leval_prop_range_ctw1500 = ((0, 0.2), (0.15, 0.35),
                            (0.3, 0.6), (0.55, 0.85), (0.8, 1.0))
train_pipeline_ctw1500 = [
    ...
    dict(type='RandomFlip', flip_ratio=0.5, direction='horizontal'),
    dict(type='Pad', size_divisor=32),
    dict(type='BSNetTargets_Out5', bs_degree=4, cp_num=8, resample_num=100,
         level_proportion_range=leval_prop_range_ctw1500),
    dict(type='CustomFormatBundle', keys=[
         'p2_maps', 'p3_maps', 'p4_maps', 'p5_maps', 'p6_maps'], visualize=dict(flag=False, boundary_key=None)),
    dict(type='Collect', keys=['img', 'p2_maps',
         'p3_maps', 'p4_maps', 'p5_maps', 'p6_maps'])
]
