...
LastEditTime: 2022-01-03 13:43:12
'''
cp_num = 8
bs_degree = 4
fourier_degree = 5
...
model = dict(type='HybridNet',
             ...
             neck=dict(type='mmdet.FPN',
                       ...
                       act_cfg=None),
             bbox_head=dict(type='HybridHead',
                            bs_degree=bs_degree,
                            cp_num=cp_num,
                            fourier_degree=fourier_degree,
                            in_channels=256,
                            scales=(8, 16, 32),
                            loss=dict(type='HybridLoss',
                                      fourier_degree=fourier_degree, bs_degree=bs_degree, cp_num=cp_num, num_sample=50),
