...
train = dict(type=dataset_type,
             ann_file=[
                 f'{data_root_ctw1500}/instances_training.json',
                 f'{data_root_MLT}/instances_training.json',
                 f'{data_root_icdar2015}/instances_training.json'
             ],
             img_prefix=[
                 f'{data_root_ctw1500}/imgs', f'{data_root_MLT}',
                 f'{data_root_icdar2015}/imgs'
             ],
             pipeline=None)
