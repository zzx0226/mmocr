...
train = dict(type=dataset_type,
             ann_file=[f'{data_root_icdar2015}/instances_training.json', f'{data_root_MLT}/instances_training.json'],
             img_prefix=[f'{data_root_icdar2015}/imgs', f'{data_root_MLT}'],
             pipeline=None)

test = dict(type=dataset_type,
            ann_file=f'{data_root_icdar2015}/instances_test.json',
            img_prefix=f'{data_root_icdar2015}/imgs',
            pipeline=None)
